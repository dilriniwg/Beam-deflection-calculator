...
st.markdown("""
    ...
    .st-bw, .st-cn, .st-cp, .st-af {
        color: #333 !important; /* Dark gray text for Streamlit components */
    }
    .st-dd {
        background-color: #fff !important; /* White background for Streamlit dropdowns */
    }
    .st-cq {
...
if page == "Home":
    ...
    **Result:** The deflection is approximately 2.17 mm.
    ...
    st.image("images/students2.jpeg", width=300)
